      ...
      ">
        ...
        <div class="card-body">
          ...
          <div class="card-actions">
            <button @click="increment(item.id)" class="button-sm border-none rounded-full p-1.5 bg-black text-white">
              +
            </button>
            <div class="mt-2">{{ item.quantity }}</div>
            <button @click="decrement(item.id)" class="button-sm border-none rounded-full p-1.5 bg-black text-white">
              -
            </button>
            <div class="mt-2">
              {{ totalAmount }}
